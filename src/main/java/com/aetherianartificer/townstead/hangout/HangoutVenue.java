...
/** A social use of one or more recognized buildings or compact decorations. */
public record HangoutVenue(ResourceLocation id, Set<String> buildings, Set<ResourceLocation> decorations, int capacity,
