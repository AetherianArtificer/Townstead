...
/** A social use of one or more recognized buildings or compact object sets. */
public record HangoutVenue(ResourceLocation id, Set<String> buildings, Set<ResourceLocation> objectSets, int capacity,
    ...
    public HangoutVenue {
        ...
        objectSets = objectSets == null ? Set.of() : Set.copyOf(objectSets);
        ...
        if (buildings.isEmpty() && objectSets.isEmpty()) {
            throw new IllegalArgumentException("buildings or object_sets must not be empty");
        }
