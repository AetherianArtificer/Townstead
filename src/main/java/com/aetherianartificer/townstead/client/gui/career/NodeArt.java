...
final class NodeArt {
    ...
    private static final MarkStyle STYLE_ACQUIRED =
            new MarkStyle(0xFF6F9445, 0xFF29401F, 0xFF91B85D, true);
    ...
    //
    // Every skill is the same-sized decision. Parent links carry hierarchy; making a path's first
    // skill physically larger invented an importance the authored graph never asked for and made
    // one icon in an otherwise even row look incorrectly scaled.
     ...
     * what kind of mark this is: plain for a skill and chamfered for a Combo Skill that belongs to
     * two careers at once.</p>
     */
