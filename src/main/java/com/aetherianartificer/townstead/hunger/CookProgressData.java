...
public final class CookProgressData {
    private static final String KEY_XP = "cookXp";
    private static final String KEY_TIER = "cookTier";
    private static final String KEY_LAST_TIER_UP_TICK = "cookLastTierUpTick";
    private static final String KEY_XP_DAY = "cookXpDay";
    private static final String KEY_XP_TODAY = "cookXpToday";

    private static final int[] TIER_XP_THRESHOLDS = {0, 110, 300, 660, 1250};
    private static final int DAILY_XP_CAP = 230;
    private static final int MAX_XP = 200000;

    private CookProgressData() {}
